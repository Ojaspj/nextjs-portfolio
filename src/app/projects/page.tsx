...
export default function page() {
  return (
    <>
      ...
      <div className="min-h-screen bg-black py-12 pt-[8rem]">
        <Boxes />

        <div>
          <div className="flex flex-col items-center justify-center">
            <h1 className=" relative inline-block text-center text-4xl font-bold text-white">
              Projects
            </h1>
            <p className="relative text-center text-neutral-500 dark:text-neutral-300">
