...
export default function Home() {
  return (
    <div className="w-full h-screen text-center bg-amber-50">
      <div className=" relative text-gray-800 max-w-[1240px] w-full h-full mx-auto p-2 flex flex-col justify-center items-center">
        <div>
        ...
        <div className=" absolute bottom-8">
          ...
          <div className="mb-6 flex flex-col items-center">
            ...
            <div className=" font-normal p-2 border border-gray-800 animate-pulse  rounded-xl shadow-sm">
              <h1>Scroll Down</h1>
            </div>
          </div>
